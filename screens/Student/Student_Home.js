    ...
    return (
      <Block>
        <ScrollView>
          ...
          <TouchableOpacity style={[styles.card, { backgroundColor: '#008080' }]} onPress={() => this.props.navigation.navigate("FYP1_Home_Student")}>
          ...
          <TouchableOpacity style={[styles.card, { backgroundColor: '#008080' }]}  onPress={() => this.props.navigation.navigate("FYP2_Home_Student")}>
            <View style={styles.cardHeader}>
