...
class FYP2_FinalEvaluation_External extends React.Component {
  ...
  async Submit() {
    ...
    await fetch('http://'+ip+':3006/fyp2finalevaluationexternal_add?title=' + title + ' &member1Name=' + member1Name + '&member2Name=' + member2Name + 
    ' &member3Name=' + Member3Name + ' &supervisorEmail=' + supervisorEmail + ' &coSupervisorEmail=' + coSupervisorEmail + ' &member1Email=' + member1Email +
