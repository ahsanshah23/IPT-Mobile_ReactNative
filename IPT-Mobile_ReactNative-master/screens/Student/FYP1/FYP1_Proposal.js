...
class FYP1_Proposal extends React.Component {
  ...
  async Submit() {
    ...
    if (title === "" || type === "" || abstract === "" || leaderID === "" || member1ID === "" || supervisor === "") {
  ...
  render() {
    return (
      <Block style={{ opacity: this.state.opacityNumber }} flex center>
        <Spinner
          visible={this.state.spinner}
          textContent={'Proposal Added!'}
