...
class FYP2_Final_Evaluation_External_View extends React.Component {
  constructor(props) {
    super(props);
    //Initial State
    this.state = {
  ...
  async getdata()
  {
    ...
    {
      await fetch('http://' + ip + '/api/fyp2get/GetFypExternalMarks?id=' + this.state.leaderID + '')
      .then(res => res.json())
      .then(users1 => {
    ...
    {
        await fetch('http://' + ip + '/api/fyp2get/GetFypExternalMarks?id=' + this.state.member1ID + '')
        .then(res => res.json())
        .then(users2 => {
    ...
    {
      await fetch('http://' + ip + '/api/fyp2get/GetFypExternalMarks?id=' + this.state.member2ID + '')
      .then(res => res.json())
      .then(users3 => {
...
export default FYP2_Final_Evaluation_External_View;