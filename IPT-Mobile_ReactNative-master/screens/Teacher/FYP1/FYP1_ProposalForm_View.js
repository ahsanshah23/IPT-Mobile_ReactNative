...
class FYP1_ProposalForm_View extends React.Component {
    ...
    async getstatus() {
        ...
        await fetch('http://' + ip + '/api/fyp1get/ProposalStatus?id=' + leader + ' ')
            .then(res => res.json())
            .then(users => {
    ...
    async getdata() {
        ...
        fetch('http://' + ip + '/api/fyp1get/GetProposalDetails?id=' + leader + ' ')
            .then(res => res.json())
            .then(users => {
        ...
        return (
            <Block flex center>
                ...
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 30 }}>
                    ...
                    <Block style={{ marginTop: 20, flex: 0.33, flexDirection: 'column', marginTop: theme.SIZES.BASE, justifyContent: 'center', alignItems: 'center' }}>
                        <Block>
                            <Button
                                shadowless
                                style={styles.button}
